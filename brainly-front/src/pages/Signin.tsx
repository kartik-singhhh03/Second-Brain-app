...
export function Signin() {
  ...
  async function handleForgotPassword() {
    ...
    try {
      await axios.post(BACKEND_URL + "/api/v1/forgot-password", { email });
    ...
    return (
      <div className="min-h-screen bg-[#0a0a0f] relative overflow-hidden flex items-center justify-center">
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-0 right-1/4 w-[600px] h-[600px] bg-violet-500/15 rounded-full blur-[120px] animate-pulse"></div>
        </div>
        <div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.02)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.02)_1px,transparent_1px)] bg-[size:50px_50px]"></div>

        <div className="relative z-10 w-full max-w-md mx-4">
          <div className="bg-[#12121a]/80 backdrop-blur-2xl border border-gray-800/50 rounded-3xl p-8 shadow-2xl">
            {!resetEmailSent ? (
              <>
                <button onClick={() => setShowForgotPassword(false)} className="flex items-center gap-2 text-gray-400 hover:text-white mb-6 transition-colors">
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    ...
                    <input ref={emailRef} type="email" placeholder="Enter your email" className="w-full pl-12 pr-4 py-3.5 bg-[#0a0a0f]/50 border border-gray-800 rounded-xl text-white placeholder-gray-600 outline-none focus:border-purple-500/50 focus:ring-2 focus:ring-purple-500/20 transition-all" />
                  </div>
                </div>

                <button onClick={handleForgotPassword} disabled={resetLoading} className="w-full py-4 bg-gradient-to-r from-purple-600 to-violet-600 hover:from-purple-500 hover:to-violet-500 disabled:opacity-50 text-white font-semibold rounded-xl transition-all shadow-lg shadow-purple-500/25">
                  {resetLoading ? (
              ...
              <div className="text-center">
                ...
                <button onClick={() => { setShowForgotPassword(false); setResetEmailSent(false); }} className="text-purple-400 hover:text-purple-300 font-semibold transition-colors">
                  ← Back to sign in
                </button>
              </div>
            )}
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] relative overflow-hidden">
      {/* Animated Background */}
      <div className="absolute inset-0">
        <div className="absolute top-0 right-1/4 w-[800px] h-[800px] bg-purple-600/20 rounded-full blur-[150px] animate-pulse"></div>
        <div className="absolute bottom-0 left-1/4 w-[600px] h-[600px] bg-violet-500/15 rounded-full blur-[120px] animate-pulse"></div>
        ...
        <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12">
          ...
          <div className="max-w-lg">
            ...
            <p className="text-gray-400 text-xl mb-8">
              Access your saved content, ideas, and knowledge from anywhere, anytime.
            </p>
            ...
            <div className="grid grid-cols-3 gap-6">
              {[
                ...
                { number: '1M+', label: 'Links Saved' },
                { number: '99.9%', label: 'Uptime' },
              ].map((stat, idx) => (
                <div key={idx} className="text-center">
                  <p className="text-3xl font-bold text-purple-400">{stat.number}</p>
          ...
          <div className="w-full max-w-md">
            ...
            <div className="bg-[#12121a]/80 backdrop-blur-2xl border border-gray-800/50 rounded-3xl p-8 shadow-2xl shadow-purple-500/5">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-500">Sign in to continue to your brain</p>
              </div>
              ...
              <form onSubmit={(e) => { e.preventDefault(); handleSignin(); }} className="space-y-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input ref={usernameRef} type="text" placeholder="Enter your username" className="w-full pl-12 pr-4 py-3.5 bg-[#0a0a0f]/50 border border-gray-800 rounded-xl text-white placeholder-gray-600 outline-none focus:border-purple-500/50 focus:ring-2 focus:ring-purple-500/20 transition-all" />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input ref={passwordRef} type={showPassword ? "text" : "password"} placeholder="Enter your password" className="w-full pl-12 pr-12 py-3.5 bg-[#0a0a0f]/50 border border-gray-800 rounded-xl text-white placeholder-gray-600 outline-none focus:border-purple-500/50 focus:ring-2 focus:ring-purple-500/20 transition-all" />
                ...
                <div className="flex items-center justify-between py-1">
                  <label className="flex items-center gap-2.5 cursor-pointer group">
                    <input type="checkbox" checked={rememberMe} onChange={(e) => setRememberMe(e.target.checked)} className="w-4 h-4 rounded border-gray-700 bg-[#0a0a0f] text-purple-600 focus:ring-purple-500 focus:ring-offset-0 cursor-pointer" />
                    <span className="text-gray-400 text-sm group-hover:text-gray-300 transition-colors">Remember me</span>
                  </label>
                  <button type="button" onClick={() => setShowForgotPassword(true)} className="text-purple-400 hover:text-purple-300 text-sm font-medium transition-colors">
                    Forgot password?
                  </button>
                </div>
              ...
              <div className="mt-6 p-4 bg-purple-600/10 border border-purple-500/30 rounded-xl">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-purple-400 text-sm font-semibold">Demo Credentials</span>
                </div>
                <div className="grid grid-cols-2 gap-2 text-sm">
                  <div className="bg-[#0a0a0f]/50 rounded-lg px-3 py-2">
                    <span className="text-gray-500">Username:</span>
                    <span className="text-white ml-2 font-mono">demo</span>
                  </div>
                  <div className="bg-[#0a0a0f]/50 rounded-lg px-3 py-2">
                    <span className="text-gray-500">Password:</span>
                    <span className="text-white ml-2 font-mono">demo123</span>
                  </div>
                </div>
              </div>
            </div>
